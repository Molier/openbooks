...
# Remove image
docker rmi evanbuss/openbooks:latest
```
...
```bash
docker pull evanbuss/openbooks:4.3.0
```
...
- **Docker Hub:** https://hub.docker.com/r/evanbuss/openbooks
...
```bash
# Container 1
docker run -d --name openbooks1 -p 8383:80 evanbuss/openbooks --name user1 ...

# Container 2
docker run -d --name openbooks2 -p 8384:80 evanbuss/openbooks --name user2 ...
```
